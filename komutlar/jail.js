...
exports.run = function(client, message, args) {//splashen
  ...
  .setTitle(` <a:jke:782202543542370324> • __\`Bir Kullanıcı Jaile Atıldı \`__   `)
  .setDescription(`
<a:jke:782202543542370324> • __**\`Yetkili\`**__ ${message.author}
<a:jke:782202543542370324> • __**\`Kullanıcı\`**__ ${jailli} 

<a:jke:782202543542370324> • __**\`Jaile Atılma Sebebi\`**__ \n• __\`${sebep}\`__
`)
  
  let embed = new Discord.RichEmbed()
  .setTitle(` <a:jke:782202543542370324> • __\`Kullanıcı Başarıyla Jaile Atıldı\`__   `)
  .setDescription(`<a:jke:782202543542370324> • __**\`Yetkili\`**__ ${message.author}`)
