...
exports.run = function(client, message, args) {//splashen
  ...
  .setTitle(` <a:jke:782202543542370324> • __\`Bir Kullanıcı Jailden Çıkarıldı\`__   `)
  .setDescription(`
<a:jke:782202543542370324> • __**\`Çıkaran Yetkili\`**__ ${message.author}
<a:jke:782202543542370324> • __**\`Çıkarılan Kullanıcı\`**__ ${abone}`)
  .setThumbnail(abone.user.avatarURL)
  
  
  let embed = new Discord.RichEmbed()
  .setTitle(` <a:jke:782202543542370324> • __\` Kullanıcı Başarıyla Jailden Çıkarıldı\`__   `)
